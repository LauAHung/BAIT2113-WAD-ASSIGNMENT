<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FlightPassengerInfoOneWay.aspx.cs" Inherits="Assignemnt_Draft_1.WebPage.FlightPassengerInfoPage.FlightPassengerInfoOneWay" %>
    ...
    <form id="form1" runat="server">
                ...
                <div class="box">
                    <div class="trip-container">
                        <div class="trip-header">
                            ...
                            <asp:Button ID="ChangeFlightButton" runat="server" CssClass="change-flight" Text="Change Flight" />
                        </div>
                        <!-- Depart Section -->
        ...
        <script>
            function fetchSuggestions(query) {
                ...
                xhr.open("POST", "FlightPassengerInfoOneWay.aspx/GetSuggestions", true);
